...
namespace Task1.GenericDiagonalMatrix
{
    ...
    internal class DiagonalMatrix<T>
    {
        ...
        readonly int _size;
        //private ints
        private int previousIndxOfTypeT = 0;
        ...
        public T? this[int i, int j]
        {
            ...
            set
            {
                ...
                {
                    previousIndxOfTypeT = i;
                    previousValue = MatrixArray[i];
                    MatrixArray[i] = value;
                    OnElementChanged(new ElementChangedEventArgs<T>(previousIndxOfTypeT, previousValue, value));
                }
            }
        }
        public DiagonalMatrix(params T[] squareDiagonalMatrix)
        {
